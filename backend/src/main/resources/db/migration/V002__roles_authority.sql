create sequence clinica_medica.authority_id_seq;
create sequence clinica_medica.role_id_seq;

create table clinica_medica.roles(
  id bigint not null default nextval('clinica_medica.role_id_seq'::regclass),
...
create table clinica_medica.authorities(
  id bigint not null default nextval('clinica_medica.authority_id_seq'::regclass),
  name varchar(50) not null,
